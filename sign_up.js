	function checkinput() {
		...
		if (checkinput1(input1)==false||checkinput1(input2)==false) {
		alert("You need to include every team member once and only once; separate each two members by a semicolon and a space.");
		return false;
		}
		return true;
	}
